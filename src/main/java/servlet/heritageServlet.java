...
@WebServlet(name = "heritageServlet", value = "/heritage1")
public class heritageServlet extends HttpServlet {
...
//        int itemId = Integer.parseInt(request.getParameter("itemId"));
        ...
        try {
            ...
            FyInfo uselist = database.getFyInfo(storedItemId);
            request.setAttribute("userInfo",uselist);
            // 转发到显示用户信息的JSP页面
            request.getRequestDispatcher("heritage1.jsp").forward(request, response);
            //转发
